...
if(!file.exists("UCI_HAR_Dataset.zip")){
  ...
  dateDownloaded <- date()
  cat("Date Downloaded: ", dateDownloaded)
  #"Thu Apr 07 14:28:12 2016"
...
#This function is meant to identify the Activity Label for each Training  
#Set row based on Training Labels
